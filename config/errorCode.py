def errors(err_code):
    err_dic = {0:('OP_ERR_NONE',"정상처리"),
               ...
               -102:('OP_ERR_VERSION','버젼처리실패'),
               -103:('OP_ERR_FIREWALL','개인방화벽실패'),
               -104:('OP_ERR_MOMORY','메모리보호실패'),
               ...
               -302:('OP_ERR_OTHER_ACC_EXC','타인계좌사용오류'),
